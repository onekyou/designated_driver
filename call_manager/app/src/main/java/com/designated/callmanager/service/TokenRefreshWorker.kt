...
/**
 * Phase 3: WorkManager 기반 일일 토큰 갱신 시스템
 * 
 * 목적:
...
class TokenRefreshWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            // 3. 현재 토큰 상태 확인
            val currentToken = tokenManager.getToken("yangpyong", "default", "call_manager")
            ...
            val newSecureToken = SecureTokenManager.SecureToken(
                token = "token_${System.currentTimeMillis()}", // 간단한 토큰 생성
                channelName = "yangpyong_default_ptt",
            ...
            // 5. 토큰 유효성 검증 (옵션)
            val storedToken = tokenManager.getToken("yangpyong", "default", "call_manager")
    ...
    suspend fun forceTokenRefresh(): Boolean {
        ...
        return try {
            ...
            val testToken = SecureTokenManager.SecureToken(
                ...
                channelName = "yangpyong_test_office_ptt",
                generatedAt = System.currentTimeMillis(),
