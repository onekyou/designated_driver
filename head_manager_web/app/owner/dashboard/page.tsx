              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 whitespace-pre-line">{app.description}</p>
                    {release && (
                ...
                {isApk ? (
                  <div className="flex flex-col items-stretch gap-2 min-w-[140px]">
                    <button
                      ...
                      className="flex items-center justify-center space-x-2 px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <Download className="h-4 w-4" />
                      <span>{downloading === app.name ? '준비중...' : !release ? '준비중' : '다운로드'}</span>
                    </button>
